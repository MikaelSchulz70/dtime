...
public class TestReportRepository extends JdbcDaoSupport {
    ...
    private final String USERS_TASK_REPORTS =
            "select u.\"id\" userId, u.\"firstname\", u.\"lastname\", c.\"id\" accountId, c.\"name\" accountName, p.\"id\" taskId, p.\"name\" taskName, p.\"task_type\" taskType, p.\"is_billable\" isBillable, sum(tr.\"reportedtime\") totalTime " +
                    ...
                    "{USER_CONDITION}" +
                    "group by tr.\"id_task_contributor\", u.\"id\", u.\"firstname\", u.\"lastname\", c.\"id\", c.\"name\", p.\"id\", p.\"name\", p.\"task_type\", p.\"is_billable\" " +
    ...
    private final String TASK_REPORT =
            "select c.\"id\" accountId, c.\"name\" accountName, p.\"id\" taskId, p.\"name\" taskName, p.\"task_type\" taskType, p.\"is_billable\" isBillable, sum(tr.\"reportedtime\") totalTime " +
                    "from \"PUBLIC\".\"time_report\" tr " +
                    "join \"PUBLIC\".\"task_contributor\" a on a.\"id\" = tr.\"id_task_contributor\" " +
                    "join \"PUBLIC\".\"task\" p on p.\"id\" = a.\"id_task\" " +
                    "join \"PUBLIC\".\"account\" c on c.\"id\" = p.\"id_account\" " +
                    "where tr.\"date\" >= ? and tr.\"date\" <= ? " +
                    "group by c.\"id\", c.\"name\", p.\"id\", p.\"name\", p.\"task_type\", p.\"is_billable\" " +
                    "having sum(tr.\"reportedtime\") > 0 " +
    ...
    public List<BillableTaskTypeReport> getBillableTaskTypeReports(LocalDate fromDate, LocalDate toDate) {
        List<Map<String, Object>> rows = getJdbcTemplate().queryForList(BILLABLE_TASK_TYPE_REPORT, fromDate, toDate);
