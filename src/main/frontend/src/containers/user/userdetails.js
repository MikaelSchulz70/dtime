...
export default class UserDetails extends BaseDetails {
    ...
    constructor(props) {
        ...
        if (id === '0') {
            const user = { id: id, firstName: "", lastName: "", email: "", mobileNumber: "", activationStatus: Constants.ACTIVE_STATUS, userRole: Constants.USER_ROLE, userName: "", password: "", userCategory: Constants.EMPLOYEE_CATEGORY };
            ...
            <div className="container">
                <div className="form-group row">
                    ...
                    <div className="col-sm-6">
                        <input className="form-control" type="text" value={this.state.user.userName} name="userName" maxLength="20" onChange={this.handleChange} onBlur={this.validate} />
                    </div>
                    <div className="col-sm-4">
                        <small className="text-danger" id="userNameErrorMsg"></small>
                    </div>
                </div>
                <div className="form-group row">
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-6">
                        <select className="form-control" value={this.state.user.userCategory} name="userCategory" onChange={this.handleChange}>
                            <option value={Constants.EMPLOYEE_CATEGORY}>Employee</option>
                            <option value={Constants.SUBCONTRACTOR_CATEGORY}>Sub contractor</option>
                        </select>
                    </div>
                    <div className="col-sm-4">
                        <small className="text-danger" id="userCategoryErrorMsg"></small>
                    </div>
                </div>
                <div className="form-group row">
